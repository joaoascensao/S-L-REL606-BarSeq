...
Compute cofitness matrices for each genetic background
...
for i,exp in enumerate(exps):
	iname=exps1[i]
	dfi = pd.read_csv(dirs[exp]+'data/fitness/{}{}_fitness.csv'.format(iname))
...
df_save.to_csv('{}{}_cofitness.csv'.format(strain))